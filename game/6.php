...
<body>
    ...
    <div class="quiz six">
        ...
        <div class="question">
            В состав десерта The Frrrozen Haute Chocolate входит:
        </div>
            <div class="answers">
                <div id="answer1">алмазная пыль</div>
                <div id="answer2">золотая стружка</div>
                <div id="answer3">хрустальная крошка</div>
            </div>
