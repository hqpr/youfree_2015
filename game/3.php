...
<body>
    ...
    <div class="quiz three">
        ...
        <div class="question" style="font-size: 31px;">
            Стоимость напитка Kentucky Derby`s Special Mint Julep, который можно попробовать только раз в году и только в Кентукки, составляет:
        </div>
            <div class="answers">
                <div id="answer1">500 долларов</div>
                <div id="answer2">1000 долларов </div>
                <div id="answer3">1500 долларов</div>
            </div>
        ...
        $(document).ready(function(){
            $('#answer1, #answer2, #answer3, #answer4').click(function(){
                ...
                $('.confirm').css("visibility", "visible").click(function(){
                    function results(){
                        if ($('#answer'+correct).hasClass('selected')) {
                            $('#answer'+correct).removeClass('selected').addClass('correct');
                            ...
                            $('#answer'+correct).removeClass('selected').addClass('correct_was');
                        }
                    }
                    results();
