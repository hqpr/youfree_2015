...
<body>
    ...
    <div class="quiz seven">
        ...
        <div class="question">
            Максимальная скорость автомобиля-амфибии:
        </div>
            <div class="answers">
                <div id="answer1">96 км/ч</div>
                <div id="answer2">40 км/ч</div>
                <div id="answer3">150 км/ч</div>
            </div>
        ...
        <div class="next">
            <a href="/game/8.php"><img src="/images/next.png" alt=""/></a>
        </div>
