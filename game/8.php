...
<body>
    ...
    <div class="quiz eight">
        ...
        <div class="question">
            Сколько видов рыб и морепродуктов входит в состав супа «Буйабес Империал»?
        </div>
            <div class="answers">
                <div id="answer1">чем больше, тем лучше</div>
                <div id="answer2">40</div>
                <div id="answer3">7</div>
            </div>
        ...
        <div class="next">
            <a href="/game/9.php"><img src="/images/next.png" alt=""/></a>
        </div>
