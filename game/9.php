...
<body>
    ...
    <div class="quiz nine">
        ...
        <div class="question">
            Какое место считается раем для рейверов?
        </div>
            <div class="answers">
                <div id="answer1">Ибица</div>
                <div id="answer2">Сен-Тропе</div>
                <div id="answer3">Гоа</div>
            </div>
        ...
        <div class="next">
            <a href="/game/10.php"><img src="/images/next.png" alt=""/></a>
        </div>
