...
<body>
    ...
    <div class="game_content">
        <div class="game_col">
            <p>В мире есть множество способов устроить себе удивительный и незабываемый отдых.
                <br/>
                <br/>
                <a style="color: #ffffff" href="/surfing.php">Узнай о них побольше</a>, и проверь, насколько ты разбираешьсяв удивительном!</p>
